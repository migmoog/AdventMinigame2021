...
class FlxNestedText extends FlxNestedSprite
{
	...
	/**
	 * The width of the `TextField` object used for bitmap generation for this `FlxNestedText` object.
	...
	/**
	 * Creates a new `FlxNestedText` object at the specified position.
	 *
	 ...
	 */
	public function applyMarkup(input:String, rules:Array<FlxTextFormatMarkerPair>):FlxNestedText
	{
	...
	/**
	 * Adds another format to this `FlxNestedText`
	 *
	 ...
	 */
	public function addFormat(Format:FlxTextFormat, Start:Int = -1, End:Int = -1):FlxNestedText
	{
	 ...
	 */
	public function removeFormat(Format:FlxTextFormat, ?Start:Int, ?End:Int):FlxNestedText
	{
	 ...
	 */
	public function clearFormats():FlxNestedText
	{
		_formatRanges = [];
		updateDefaultFormat();
	 ...
	 * @param	EmbeddedFont	Whether this text field uses embedded fonts or not
	 * @return	This `FlxNestedText` instance (nice for chaining stuff together, if you're into that).
	 */
	public function setFormat(?Font:String, Size:Int = 8, Color:FlxColor = FlxColor.WHITE, ?Alignment:FlxTextAlign, ?BorderStyle:FlxTextBorderStyle,
			BorderColor:FlxColor = FlxColor.TRANSPARENT, EmbeddedFont:Bool = true):FlxNestedText
	{
	 ...
	 */
	public inline function setBorderStyle(Style:FlxTextBorderStyle, Color:FlxColor = 0, Size:Float = 1, Quality:Float = 1):FlxNestedText
	{
		borderStyle = Style;
		borderColor = Color;
		borderSize = Size;
...
@:allow(flixel.text.FlxNestedText.applyFormats)
class FlxTextFormat
{
	/**
...
enum FlxTextBorderStyle
{
	 ...
	 * Use `FlxNestedText.shadowOffset` for custom placement.
	 */
	SHADOW;
